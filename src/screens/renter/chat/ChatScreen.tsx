...
import { setSelectedConversation } from '../../../redux-toolkit/slices/conversationSlice';
...
const ChatScreen: React.FC = () => {
    ...
    const renderConversation = ({ item }: { item: IConversation }) => {
        ...
        const lastMessage =
            item.chats.length > 0 ? item.chats[item.chats.length - 1] : null;
                    ...
                    {avatarUrl ? (
                        ...
                        <View style={styles.nameInitials}>
                            <Text style={styles.initials}>
                                {getFirstAndLastName(otherParticipant.name)}
                            </Text>
                        </View>
                    )}
