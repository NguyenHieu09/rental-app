...
//             // Prepare the form data to send to your API
...
//                 const blob = await response.blob(); // Create a Blob from the URI

//                 formData.append('images', blob, image.fileName); // Append the blob
//             }
