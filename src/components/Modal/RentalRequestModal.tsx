...
const RentalRequestModal: React.FC<RentalRequestModalProps> = ({ isVisible, onClose, propertyId, ownerId, userId }) => {
    ...
    const handleRentalRequest = async () => {
        ...
        const rentalRequestData = {
            ownerId,
            property: { propertyId }, // Ensure propertyId is used correctly
